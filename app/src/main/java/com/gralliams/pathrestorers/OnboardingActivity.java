...
public class OnboardingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private com.gralliams.pathrestorers.SliderAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new com.gralliams.pathrestorers.SliderAdapter(this);
        ...
        switch (v.getId()){
            case R.id.btn_next:
                if (buttonNext.getText().toString().equalsIgnoreCase("next")){
                    ...
                    startActivity(new Intent(com.gralliams.pathrestorers.OnboardingActivity.this, MainActivity.class));
                    finish();
                }
                break;
